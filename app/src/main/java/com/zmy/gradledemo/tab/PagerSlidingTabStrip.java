...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFffd500;
...
//        indicatorWrap = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsIndicatorWrap, indicatorWrap);
    ...
    private void addTab(final int position, View tab, View tab2) {
        ...
        FrameLayout titleView = new FrameLayout(getContext());
...
//            canvas.drawRect(lineLeft+tabPadding, height - indicatorHeight, lineRight-tabPadding, height, rectPaint);
            canvas.drawRoundRect(lineLeft+tabPadding, height - indicatorHeight, lineRight-tabPadding, height, 10, 10, rectPaint);

        } else {
//            canvas.drawRect(lineLeft+tabPadding, height - indicatorHeight, lineRight-tabPadding, height, rectPaint);
            canvas.drawRoundRect(lineLeft+tabPadding, height - indicatorHeight - 8, lineRight-tabPadding, height - 8, 10, 10, rectPaint);
        }
