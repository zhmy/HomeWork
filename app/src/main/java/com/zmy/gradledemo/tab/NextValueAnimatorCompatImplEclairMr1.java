...
public class NextValueAnimatorCompatImplEclairMr1 extends NextValueAnimatorCompat.Impl {
    ...
    private NextValueAnimatorCompat.Impl.AnimatorListenerProxy mListener;
    private NextValueAnimatorCompat.Impl.AnimatorUpdateListenerProxy mUpdateListener;
    ...
    @Override
    public void setListener(NextValueAnimatorCompat.Impl.AnimatorListenerProxy listener) {
        mListener = listener;
    }

    @Override
    public void setUpdateListener(NextValueAnimatorCompat.Impl.AnimatorUpdateListenerProxy updateListener) {
    ...
    public int getAnimatedIntValue() {
        return NextAnimationUtils.lerp(mIntValues[0], mIntValues[1], getAnimatedFraction());
    }
    ...
    public float getAnimatedFloatValue() {
        return NextAnimationUtils.lerp(mFloatValues[0], mFloatValues[1], getAnimatedFraction());
    }
