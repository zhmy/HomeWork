...
Check performed at Wed Oct 26 14:01:08 CST 2016.<br/>
...
<span class="location"><a href="../../src/main/java/com/projectseptember/RNGL/GLCanvasManager.java">../../src/main/java/com/projectseptember/RNGL/GLCanvasManager.java</a>:96</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>String.format(Locale, ...)</code> instead</span><br /><pre class="errorlines">
<span class="lineno">  93</span>                 return;
<span class="lineno">  94</span>             }
<span class="lineno">  95</span>             default:
<span class="lineno">  96</span>                 throw new IllegalArgumentException(<span class="errorspan">String.format(</span>
<span class="lineno">  97</span>                         "Unsupported command %d received by %s.",
<span class="lineno">  98</span>                         commandType,
</pre>
<span class="location"><a href="../../src/main/java/com/projectseptember/RNGL/GLImage.java">../../src/main/java/com/projectseptember/RNGL/GLImage.java</a>:93</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>toLowerCase(Locale)</code> instead</span><br /><pre class="errorlines">
<span class="lineno">  90</span>         if (name == null || name.isEmpty()) {
<span class="lineno">  91</span>             return null;
<span class="lineno">  92</span>         }
<span class="lineno">  93</span>         name = name.<span class="errorspan">toLowerCase().replace("-", "_");</span>
<span class="lineno">  94</span>         int resId = context.getResources().getIdentifier(
<span class="lineno">  95</span>                 name,
</pre>
</div>
...
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/projectseptember/RNGL/GLShader.java">../../src/main/java/com/projectseptember/RNGL/GLShader.java</a>:161</span>: <span class="message">Call requires API level 17 (current min is 16): <code>android.opengl.GLES20#glGetActiveUniform</code></span><br /><pre class="errorlines">
<span class="lineno"> 158</span>         int[] sizePointer = new int[1];
<span class="lineno"> 159</span>         glGetProgramiv(program, GL_ACTIVE_UNIFORMS, nbUniforms, 0);
<span class="lineno"> 160</span>         for (int i=0; i &lt; nbUniforms[0]; i++) {
<span class="lineno"> 161</span>             String uniformName = <span class="errorspan">glGetActiveUniform(program, i, sizePointer, 0, typePointer, 0);</span>
<span class="lineno"> 162</span>             int size = sizePointer[0];
<span class="lineno"> 163</span>             int type = typePointer[0];
</pre>
</div>
...
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:7</span>: <span class="message">A newer version of com.android.tools.build:gradle than 1.3.0 is available: 2.2.0</span><br /><pre class="errorlines">
<span class="lineno">   4</span>   }
<span class="lineno">   5</span> 
<span class="lineno">   6</span>   dependencies {
<span class="lineno">   7</span>     <span class="errorspan">classpath 'com.android.tools.build:gradle:1.3.0'</span>
...
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/projectseptember/RNGL/GLCanvas.java">../../src/main/java/com/projectseptember/RNGL/GLCanvas.java</a>:49</span>: <span class="message">Custom view <code>GLCanvas</code> is missing constructor used by tools: <code>(Context)</code> or <code>(Context,AttributeSet)</code> or <code>(Context,AttributeSet,int)</code></span><br /><pre class="errorlines">
<span class="lineno">  46</span> import javax.microedition.khronos.egl.EGLConfig;
<span class="lineno">  47</span> import javax.microedition.khronos.opengles.GL10;
<span class="lineno">  48</span> 
<span class="lineno">  49</span> public class <span class="errorspan">GLCanvas extends GLSurfaceView</span>
<span class="lineno">  50</span>         implements GLSurfaceView.Renderer, Executor, ReactPointerEventsView {
