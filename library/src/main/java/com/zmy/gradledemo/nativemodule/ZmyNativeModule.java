...
public class ZmyNativeModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    private static final String TestEventName = "TestEventName";
    private Timer timer;

    public ZmyNativeModule(final ReactApplicationContext reactContext) {
        super(reactContext);
        //开启定时器
    ...
    public void getNativeClass(Callback callback) {
        callback.invoke("ZmyNativeModule");
    }
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put("ZmyNativeModule", "ZmyNativeModuleValue");
        return constants;
    }
